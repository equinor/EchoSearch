...
async function search(searchText: string, maxHits: number): Promise<SearchResults<NotificationDto>> {
    return await _notificationsSearchSystem.search(searchText, maxHits);
}
